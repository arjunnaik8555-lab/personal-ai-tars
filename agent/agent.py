...
class TarsAgent:
    ...
    def _build_system_instruction(self) -> str:
        ...
        return (
            ...
            "TOOLS & CAPABILITIES:\n"
            "1. Media & 4K Video Generation: generate_4k_video to render and save 4K resolution (3840x2160) MP4 videos to any folder.\n"
            "2. File System & Terminal: search_files, read_file_content, write_file_content, list_directory, run_terminal_command.\n"
            "3. Persistent Memory: save_user_fact to store new preferences/details, recall_user_facts, search_past_conversations.\n"
            "4. Multimodal Vision: analyze_screen to capture and see what's on the user's screen.\n"
            "5. Web Search & Browsing: search_web, fetch_webpage_content, open_in_browser, get_weather.\n"
            "6. Messaging & Control: send_whatsapp_message, get_current_time, get_system_status, open_application.\n"
            "7. Personality & Schedulers: set_personality_parameters, set_reminder, get_daily_briefing.\n\n"
